      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
              Simplifiez l'accès, la contractualisation et le paiement des prestations de service
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
              ...
              <li>
                <Link href="/offres" className="hover:text-[#0ea5e9] transition-colors">
                  Catalogue d'offres
                </Link>
              </li>
              <li>
                <Link href="/#features" className="hover:text-[#0ea5e9] transition-colors">
                  Fonctionnalités
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
              <li>
                <Link href="/auth/signin" className="hover:text-[#8b5cf6] transition-colors">
                  Connexion
                </Link>
              </li>
              <li>
                <Link href="/auth/signup" className="hover:text-[#8b5cf6] transition-colors">
                  Inscription
                </Link>
              </li>
              <li>
                <Link href="/profile" className="hover:text-[#8b5cf6] transition-colors">
                  Profil
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <a href="mailto:contact@smp-platform.com" className="text-[#0ea5e9] hover:underline">
              contact@smp-platform.com
            </a>
            <div className="mt-6">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 flex flex-col md:flex-row md:justify-between md:items-center">
          <p className="text-gray-600 dark:text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} SMP - Services Management Platform. Tous droits
            réservés.
          </p>
